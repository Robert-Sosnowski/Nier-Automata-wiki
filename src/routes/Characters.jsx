            ...
            <Container style={{
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={character2b} alt='' style={{width: "50%", height: "50%"}}/>
                        <GetCharacter id={1}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={character9s} alt='' style={{width: "50%", height: "50%"}}/>
                        <GetCharacter id={2}/>
                    </div>
                </Col>
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={characterA2} alt='' style={{width: "50%", height: "50%"}}/>
                        <GetCharacter id={3}/>
                    </div>
                </Col>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={characterAnemone} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={11}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={characterPopola} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={6}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={characterDevola} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={5}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={characterPascal} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={7}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={characterEmil} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={10}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={characterCommander} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={4}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={character21O} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={12}/>
                    </div>
                ...
                <Col>
                    <div style={{border: "5px", borderColor: "black"}}>
                        <img src={character6O} alt='' style={{width: "75%", height: "75%"}}/>
                        <GetCharacter id={13}/>
                    </div>
